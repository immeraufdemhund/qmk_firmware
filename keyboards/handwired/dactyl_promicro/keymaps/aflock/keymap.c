...
EXPR000,KC_QUOT,KC_GRV ,KC_LEFT,KC_RGHT,KC_BSPC,                                         KC_SPC ,KC_UP  ,KC_DOWN,KC_LBRC,KC_RBRC,TT(1)  ,
                                        KC_DEL ,KC_LGUI,KC_LALT,         KC_RALT,KC_RGUI,KC_ENT                                         ,
                                                        KC_HOME,         KC_PGUP                                                        ,
                                                        TG(2)  ,         KC_PGDN),
